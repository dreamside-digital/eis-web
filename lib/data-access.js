  ...
  try {
    ...
    const data = await api.request(
      readSingleton('profiles', {
        fields: '*,location,location.*,tags.tags_id.*,profile_picture,profile_picture.*,additional_images.directus_files_id.id,additional_images.directus_files_id.description,additional_images.directus_files_id.height,additional_images.directus_files_id.width',
        filter: {
          slug: {
            _eq: slug
          }
