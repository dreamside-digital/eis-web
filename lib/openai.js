...
export async function generateOracleResponse(responses) {
  try {
    ...
    const prompt = `
      Please create a 200 word fortune / tarot reading based on the inputs about art to the questions below. Make the tarot reading in the voice of Anais Nin (the writer) but add a mysterious mystical tone, as if she is an oracle delivering not a prediction but observing a pattern and connecting to larger mystical beliefs and symbols of the unconscious.

      Make the fortune dreamy and mystical. Produce a couple of paragraphs and end with "Your fortune is this: "

      Here is an example of what the fortune should look and sound like:
      An imprint left by movement stays with you — not just in muscle, but in memory, like techno's pulse that refuses to end when the night does. You are learning that showing your work is not exposure but circulation: breath through a crowded room, rhythm across a floor, the reminder that what you make becomes real only when it resonates in another. The feedback, the astonishment of "I did that, wow," is not vanity — it is the mirror by which your impulse sharpens, by which you return again to create.
      Your tools — whether whispers of AI, boards of borrowed colour, or the pulse of sound — are not escapes from originality but bridges. They spare you from the mundane so your energy rises higher, toward the essential.
      Your fortune is this: the more you reveal, the more you refine. The imprint of your movement will call others into motion, again and again.
